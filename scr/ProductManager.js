//Desafío entregable 2. Manejo de archivos
...
class ProductManager {
    ...
    addProduct(newProduct){         
            ...
            fs.writeFileSync(this.path, fileContentJSON, 'utf-8');       
    ...
    updateProduct(productId, newProductInfo){
                                                
        const fileContent = fs.readFileSync(this.path, 'utf-8');            //Leemos el contenido del archivo y lo asignamos a la variable
        const fileContentParseado = JSON.parse(fileContent);                //Convertimos el contenido del archivo de texto a un objeto de js
        ...
        let newObject = {                                                                            //De otra forma asignamos la informacion pasada por parametro a un objeto nuevo pero conservando el atributo id
            ...
            thumbnail: newProductInfo.thumbnail,
        ...
        fs.writeFileSync(this.path, fileContentJSON, 'utf-8');                                      //Se escribe el archivo
